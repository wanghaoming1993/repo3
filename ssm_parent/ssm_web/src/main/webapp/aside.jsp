		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a
						href="${pageContext.request.contextPath}/product/findAll?page=1&pageSize=${pi.pageSize}">
							<i class="fa fa-circle-o"></i> 产品管理
					</a></li>
					<li id="system-setting"><a
						href="${pageContext.request.contextPath}/orders/findAllPages?page=1&pageSize=${pi.pageSize}"> <i
