	...
	<%--<c:forEach items="${permissionList}" var="permission">
		<tr>
			...
			<td class="text-center">
				<a href="${pageContext.request.contextPath}/role/findById?id=${permission.id}" class="btn bg-olive btn-xs">详情</a>
				<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole?id=${role.id}" class="btn bg-olive btn-xs">添加角色</a>
			</td>
		</tr>
	</c:forEach>--%>
	...
	<script>
		...
		function load() {
			$.ajax({
				...
				dataType:"json",
				url:"${pageContext.request.contextPath}/permission/findddd",
				...
				$("#permissionTbody").html(permissionStr);
                }
